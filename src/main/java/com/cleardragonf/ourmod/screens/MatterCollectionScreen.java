...
public class MatterCollectionScreen extends AbstractContainerScreen<MatterCollectionMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(OurMod.MODID, "textures/gui/matter_collection_gui.png");
    ...
    public MatterCollectionScreen(MatterCollectionMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
