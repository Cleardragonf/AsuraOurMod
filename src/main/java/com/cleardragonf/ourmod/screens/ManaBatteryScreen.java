...
public class ManaBatteryScreen extends AbstractContainerScreen<ManaBatteryMenu> {
    ...
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(OurMod.MODID, "textures/gui/mana_battery_gui.png");
    ...
    public ManaBatteryScreen(ManaBatteryMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
